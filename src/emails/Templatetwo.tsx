...
import * as React from 'react';
  ...
  export const Templatetwo = ({firstName}: TemplatetwoProps) => (
    <Html>
      <Head />
        ...
        <Container style={container}>
          ...
          <Section style={message}>
            <Img
              ...
              style={{ margin: 'auto' }}
            />
            <Heading style={global.heading}>Subject.{firstName}</Heading>
            <Text style={global.text}>
              Lesser Subject.
            </Text>
            <Text style={{ ...global.text, marginTop: 24 }}>
              We´ve. paragraph paragraph paragraph paragraph paragraph paragraph paragraph paragraph paragraph paragraph paragraph paragraph paragraph paragraph paragraph paragraph paragraph 
              paragraph paragraph paragraph paragraph paragraph paragraph paragraph paragraph.
            </Text>


               
                <Link href="/"  ><Button style={{...global.button, paddingTop:15 , marginTop: 20 , paddingBottom:15 }}>Button</Button></Link>
...
{/*
          ...
          {/*
          <Section style={global.defaultPadding}>
            <Column style={{ display: 'inline-flex', marginBottom: 40 }}>
          ...
          <Section style={paddingY}>
            ...
            <Column style={recomendations.container}>
              <Column
          ...
          <Section style={menu.container}>
            ...
            <Column style={{ ...menu.content, paddingTop: '0' }}>
              <Column style={{ width: '33%' }} colSpan={1}>
                <Link href="/" style={menu.text}>
                  How to Return
                </Link>
...
*/}
          ...
          <Section style={paddingY}>
            ...
            <Column style={categories.container}>
              <Column align="center">
